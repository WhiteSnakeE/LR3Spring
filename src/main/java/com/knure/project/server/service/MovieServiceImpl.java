...
public class MovieServiceImpl implements MovieService {
	...
	@Override
	public int addMovie(FilmCatalog.Movie movie) throws DAOException {
		return movieDAO.addMovie(movie);
	}

	@Override
	public FilmCatalog.Movie removeMovie(int id,String clientToken, Holder<String> serverToken)
			throws DAOException {
